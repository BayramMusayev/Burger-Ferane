...
const Order = () => {
  return (
    <div className=" overflow-x-auto">
      <div
        className="min-h-[calc(100vh_-_413px)] flex justify-center items-center flex-col p-10
    min-w-[1000px]"
      >
        <div
          className="mb-10 flex items-center flex-1 
       w-full max-h-28"
        >
          <table
        ...
        <div className="flex justify-between w-full p-10 bg-primary">
          ...
          <div className="relative flex flex-col">
            <Image
              src="/images/onthevay.png "
              alt=""
              width={40}
              height={40}
              objectFit="contain"
            />
            <span>On the vay</span>
          </div>
          <div className="relative flex flex-col">
            <Image
