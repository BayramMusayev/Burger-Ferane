...
const MenuItem = () => {
  return (
    <div className="bg-secondary rounded-3xl">
      ...
      >
        <div className="relative w-36 h-36 hover:scale-110
          transition-all">
          <Image src="/images/f1.png" alt="" layout="fill"  />
        </div>
      </div>
      <div className="p-7 text-white">
        <h4 className="text-xl font-semibold">Delicious Pasta</h4>
        ...
        <div className="flex justify-between items-center mt-4">
          <span>$20</span>
          <button className="btn-primary w-10 h-10 !p-0 rounded-full grid place-content-center">
            <RiShoppingCart2Fill />{" "}
          </button>
        </div>
      </div>
